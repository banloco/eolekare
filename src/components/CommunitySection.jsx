        ...
        {BEHOLD_FEED_ID ? (
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: 3, maxWidth: 620, margin: '0 auto' }}>
            {[
              ...
              '/images/WhatsApp Image 2026-02-28 at 1.31.10 PM (2).jpg',
            ].map((src, i) => (
              <a
                key={i}
      ...
      <div style={{ display: 'flex', gap: '1rem', justifyContent: 'center', flexWrap: 'wrap' }}>
        ...
        {waNumber && (
          <a
            ...
            target="_blank"
            rel="noreferrer"
            style={{ display: 'inline-flex', alignItems: 'center', gap: 8, padding: '13px 32px', background: '#25D366', color: '#fff', textDecoration: 'none', fontSize: 10, letterSpacing: '0.25em', fontWeight: 300, textTransform: 'uppercase', fontFamily: 'Jost,sans-serif', transition: 'all 0.3s' }}
