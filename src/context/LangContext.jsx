...
export const TRANSLATIONS = {
  fr: {
    ...
    order_payment:'Paiement', order_payment_val:'Sécurisé',
    ...
    cart_total:'Total', cart_checkout:'Passer la commande →', cart_secure:'Paiement sécurisé',
  ...
  en: {
    ...
    order_payment:'Payment', order_payment_val:'Secure',
    ...
    cart_total:'Total', cart_checkout:'Checkout →', cart_secure:'Secure payment',
