      ...
      <nav className="fixed top-0 left-0 right-0 z-[100] flex justify-between items-center"
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 5 }}>
            <span style={{ fontSize: 8, fontWeight: 700, letterSpacing: '0.22em', color: '#3b190f', textTransform: 'uppercase', borderBottom: '0.5px solid #3b190f', paddingBottom: 1 }}>Bénin</span>
  ...
  return (
    <footer style={{ background: '#3b190f', padding: '4rem 3rem', textAlign: 'center' }}>
      ...
      <ul className="flex justify-center gap-12 list-none flex-wrap" style={{ marginBottom: '2rem' }}>
        {[['https://instagram.com/eolekare', 'Instagram'], [WA_BASE, 'WhatsApp'], ['https://tiktok.com/@eolekare', 'TikTok']].map(([h, l]) => (
